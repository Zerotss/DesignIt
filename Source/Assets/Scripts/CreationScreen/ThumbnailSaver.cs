...
public static class ThumbnailSaver
{
    ...
    [MenuItem("Assets/Save Prefab Thumbnails")]
    private static void ExportPrefabThumbnails()
    {
        ...
        foreach (Object selectedObject in selectedObjects)
        {
            ...
            if (selectedObject != null && PrefabUtility.GetPrefabAssetType(selectedObject) != PrefabAssetType.MissingAsset)
            {
                ...
                {
                    Debug.LogWarning("Could not generate thumbnail for the selected prefab: " + prefab.name);
                }
            }
        }
    }
